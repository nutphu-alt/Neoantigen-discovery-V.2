// Intersect variant calls from Deepsomatic
process intersect_deepsomatic {

    tag "Intersecting Deepsomatic VCFs"

    publishDir "${params.outdir}/variants/deepsomatic/intersect", mode: 'copy'
